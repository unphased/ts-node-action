return {
  ...
  toggle_declaration_keyword = require('ts-node-action.actions.toggle_declaration_keyword'),
  cycle_quotes = require("ts-node-action.actions.cycle_quotes"),
  convert_template_string = require("ts-node-action.actions.convert_template_string"),
